...
const allRecipes: Recipe[] = [
  // Whisky
  {
    ...
    ingredients: [
      { amount: '60ml', name: 'Bourbon ou Rye Whisky' },
    ...
    instructions: [
      ...
      'Macere até o açúcar começar a se dissolver.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { amount: '1', name: 'Clara de ovo (opcional)' },
      { amount: 'Cereja', name: 'Para decorar' },
    ],
    instructions: [
      'Adicione todos os ingredientes na coqueteleira sem gelo (dry shake).',
      'Agite vigorosamente por 15 segundos.',
      'Adicione gelo e agite novamente por mais 15 segundos.',
      'Coe para um copo com gelo fresco.',
      'Decore com uma cereja e uma rodela de limão.',
    ],
    prepTime: '5 min',
    servings: '1 pessoa',
    category: 'Whisky',
  ...
  // Vodka
  {
    ...
    ingredients: [
      ...
      { amount: '15ml', name: 'Suco de limão fresco' },
      { amount: '120ml', name: 'Ginger beer' },
  ...
  },
  {
    ...
    instructions: [
      ...
      'Agite vigorosamente por 15 segundos.',
      'Coe para uma taça martini gelada.',
      'Decore com uma casca de laranja flambada.',
    ],
    prepTime: '4 min',
    servings: '1 pessoa',
    category: 'Vodka',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541546339599-920d0dc5e6c9?w=600',
    ingredients: [
      { amount: '60ml', name: 'Vodka' },
      { amount: '120ml', name: 'Suco de tomate' },
      { amount: '15ml', name: 'Suco de limão' },
      { amount: '3 dashes', name: 'Molho inglês' },
      { amount: '2 dashes', name: 'Tabasco' },
    ...
    instructions: [
      ...
      'Mexa bem e decore com um talo de aipo.',
    ],
    prepTime: '5 min',
    servings: '1 pessoa',
    category: 'Vodka',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1582633007947-7b8f6e5a8a78?w=600',
    ingredients: [
      { amount: '60ml', name: 'Rum branco' },
  ...
  // Tequila
  {
    ...
    ingredients: [
      { amount: '50ml', name: 'Tequila blanco' },
      { amount: '25ml', name: 'Cointreau' },
      { amount: '25ml', name: 'Suco de limão fresco' },
      { amount: 'Para bordar', name: 'Sal grosso' },
      { amount: 'Rodela', name: 'Limão para decorar' },
    ],
    instructions: [
  ...
  {
    name: 'Paloma',
    description: 'A favorita do México. Grapefruit e tequila em harmonia.',
    image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600',
    ingredients: [
      { amount: '60ml', name: 'Tequila blanco' },
      { amount: '15ml', name: 'Suco de limão' },
      { amount: 'Completar', name: 'Refrigerante de grapefruit' },
      { amount: 'Pitada', name: 'Sal' },
      { amount: 'Fatia', name: 'Grapefruit para decorar' },
    ],
    instructions: [
      'Adicione sal na borda do copo (opcional).',
      'Encha um copo highball com gelo.',
      'Adicione a tequila e o suco de limão.',
      'Complete com refrigerante de grapefruit.',
  ...
  // Vinho
  {
    ...
    ingredients: [
      ...
      { amount: '60ml', name: 'Conhaque ou brandy' },
      { amount: '30ml', name: 'Licor de laranja' },
      { amount: '1', name: 'Laranja fatiada' },
      { amount: '1', name: 'Maçã em cubos' },
      { amount: 'Completar', name: 'Água com gás' },
    ],
    instructions: [
      'Em uma jarra grande, combine o vinho, conhaque e licor.',
      'Adicione as frutas cortadas.',
      'Refrigere por pelo menos 4 horas (idealmente overnight).',
  ...
  },
  {
    ...
    ingredients: [
      { amount: '15ml', name: 'Crème de cassis' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { amount: '30ml', name: 'Vermute tinto' },
      { amount: 'Casca', name: 'Laranja para decorar' },
    ],
    instructions: [
      'Em um copo old fashioned, adicione gelo grande.',
      'Despeje a cachaça e o vermute.',
      'Mexa suavemente por 20 segundos.',
      'Finalize com uma casca de laranja espremida.',
    ],
    prepTime: '3 min',
    servings: '1 pessoa',
    category: 'Cachaça',
  ...
  {
    name: 'Batida de Coco',
    description: 'Cremosa, tropical e deliciosamente brasileira.',
    image: 'https://images.unsplash.com/photo-1582633007947-7b8f6e5a8a78?w=600',
    ingredients: [
      { amount: '60ml', name: 'Cachaça' },
      { amount: '100ml', name: 'Leite de coco' },
      { amount: '30ml', name: 'Leite condensado' },
      { amount: '1 xícara', name: 'Gelo' },
    ],
    instructions: [
      'Adicione todos os ingredientes no liquidificador.',
      ...
      'Decore com coco ralado (opcional).',
    ],
    prepTime: '3 min',
    servings: '1 pessoa',
    category: 'Cachaça',
